...
public class PatternDecoratorTest {
    ...
    public void  easyYesTest(){
        ...
        Simulation easyYes = new SimulationEasyYes(new SimulationParameter(), new SimulationStore());
        easyYes.start();
        assertNotNull(1);
    }
    @Test
    public void  dinamicoTest(){
        ...
        Simulation seguroVidaDinamico = new SimulationVidaDinamico(new SimulationParameter(), new SimulationStore());
