...
//----------------------------------------------------------------------------------------------------------------------------------------------------
			...
			///  JhonH
			SimulationProductDAO simulationProductDAO = SimulationProductBean.createSimulationProductDAO(insuranceSimulationId, productInformationDAO.getInsuranceProductId(),
																											creationUser, userAudit, response);
